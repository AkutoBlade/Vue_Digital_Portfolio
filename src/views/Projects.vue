<template>
  <section class="bgimg row">
    <div v-for="project in projects" key="project.id" class="size col-md-4"> 
...
@media(width:768px) and (min-width:426px){
.title-position {
  top: 19%;
  left: 5%;
}
